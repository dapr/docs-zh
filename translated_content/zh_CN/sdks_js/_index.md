...
weight: 1000
description: 用于开发 Dapr 应用程序的 JavaScript SDK 软件包
no_list: true
cascade:
...
要开始使用 JavaScript SDK，请从 [NPM](https://www.npmjs.com/package/@dapr/dapr) 安装 Dapr JavaScript SDK 软件包：
...
<div class="card-deck">
  ...
  <div class="card">
    <div class="card-body">
      ...
      <p class="card-text">创建具有状态、提醒/定时器和方法的虚拟 Actor。</p>
